...
def main():
    ...
    parser = argparse.ArgumentParser(description="Konverterer en PDF-fil til Markdown ved hjelp av Gemini API.")
    ...
    if pdf_text:
        markdown_result = convert_text_to_markdown_gemini(pdf_text, model_name=args.model)
        if markdown_result:
            if args.stdout:
